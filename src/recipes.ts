...
export const RECIPES: CuisineRecipes = {
  ...
  Chinese: [
    ...
    },
    {
      ...
      type: "Dessert",
      ingredients: [
        "4 thick slices milk bread, 1-1.5 inches thick (厚牛奶麵包)",
        "2-3 tbsp smooth peanut butter (花生醬)",
        "1-2 tbsp kaya jam (optional) (咖椰醬)",
        "2 large eggs (雞蛋)",
        "2-3 tbsp evaporated milk (淡奶)",
        "Pinch of salt (鹽)",
        "300ml cooking oil for deep frying (炸油)",
        "2 tbsp butter, cut into small pats (牛油)",
        "2-4 tbsp sweetened condensed milk (煉奶)",
        "2 tbsp golden syrup or maple syrup (金糖漿或楓糖漿)",
        "Honey for serving (optional) (蜂蜜)"
      ],
      instructions: [
        "Trim crusts from thick milk bread slices (authentic Hong Kong tea restaurant style - 茶餐廳做法)",
        "Spread smooth peanut butter on two slices, kaya jam on the other two (if using)",
        "Sandwich slices together with fillings inside, pressing gently to seal edges",
        "Beat eggs with evaporated milk and pinch of salt in shallow dish (traditional Hong Kong method)",
        "Heat cooking oil in deep pan or wok to 350°F (175°C) for deep frying",
        "Dip each sandwich in egg mixture, coating both sides thoroughly and letting excess drip off",
        "Carefully lower sandwiches into hot oil using tongs (authentic deep-frying technique)",
        "Fry for 2-3 minutes until golden brown and crispy on both sides",
        "Remove from oil and drain on paper towels to remove excess oil",
        "Cut diagonally into triangles (traditional Hong Kong presentation)",
        "Top with butter pats while still hot (butter melts into the crispy exterior)",
        "Drizzle generously with sweetened condensed milk and golden syrup",
        "Serve immediately while hot and crispy (essential for authentic texture)",
        "Optional: Add honey or additional syrup for extra sweetness"
      ]
    },
    {
